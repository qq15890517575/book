...
@section('content')
    ...
    <div class="weui_cells weui_cells_form" style="display: none;">
        ...
        <div class="weui_cell weui_vcode">
            ...
            <div class="weui_cell_ft">
                <img src="api/service/validate_code/create" class="bk_validate_code"/>
            </div>
        </div>
    </div>
...
@section('my-js')
    <script type="text/javascript">
        ...
        $('.bk_validate_code').click(function () {
            $(this).attr('src', 'api/service/validate_code/create?random=' + Math.random());
        });
    ...
    <script type="text/javascript">
        ...
        $('.bk_phone_code_send').click(function (event) {
            ...
            $.ajax({
                url: 'api/service/validate_phone/send',
                type: 'POST',
                dataType: 'json',
                cache: false,
            ...
            $('input:radio[name=register_type]').each(function (index, el) {
                if ($(this).attr('checked') == 'checked') {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        data: {
                            phone: phone, email: email, password: password, confirm: confirm,
